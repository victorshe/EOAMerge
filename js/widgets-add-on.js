define("/DigiShell/js/widgets-add-on", [ "jquery", "backbone/underscore/1.5.2/underscore", "./widgets", "backbone/backbone/1.1.0/backbone", "./util", "./sidebar" ], function(require) {
    var $ = require("jquery"), _ = require("backbone/underscore/1.5.2/underscore"), widgets = require("./widgets"), util = require("./util"), sidebar = require("./sidebar");
