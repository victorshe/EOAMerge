define("/DigiShell/js/databaseQuery-debug", [ "jquery-debug", "backbone/backbone/1.1.0/backbone-debug", "backbone/underscore/1.5.2/underscore-debug", "./viewFrame-debug", "digiflow/0.2/viewPanel-debug", "./logo-debug", "./util-debug", "jquery/bootstrap/datetimepicker/datetimepicker-debug", "jquery/bootstrap/bootstrap/2.3.2/bootstrap-debug" ], function(require) {
    var $ = require("jquery-debug"), Backbone = require("backbone/backbone/1.1.0/backbone-debug"), _ = require("backbone/underscore/1.5.2/underscore-debug"), viewFrame = require("./viewFrame-debug");
    require("jquery/bootstrap/datetimepicker/datetimepicker-debug");
    require("jquery/dataTables/1.9.4/jquery.dataTables.bootstrap-debug");
    var configCache = {};
    function getQueryConfig(dbPath, id, callback) {
        var dbCache = configCache[dbPath] ? configCache[dbPath] : configCache[dbPath] = {}, configItem = dbCache[id] ? dbCache[id] : dbCache[id] = {};
        ...
        $.get("/Produce/DigiShell.nsf/getDatabaseQueryConfig.xsp", {
            ...
            //TODO 异常信息待完善
            if (resp.responseText.indexOf("<!DOCTYPE HTML PUBLIC") === 0 && resp.responseText.indexOf('<input name="RedirectTo" value=') !== -1) {
    ...
    var Query = Backbone.View.extend({
        ...
        initialize: function() {
            ...
            _this.$el.find("form").on("submit", function(event) {
                ...
                $(event.target).find("[data-bind]").each(function() {
                    var input = $(this), bind = input.data("bind");
        ...
        loadQuery: function(dbPath, id) {
            ...
            getQueryConfig(dbPath, id, function(queryConfig) {
                ...
                _this.$el.find("form .date").datetimepicker({
                    ...
                    todayBtn: true,
                    autoclose: true,
                    language: digishell.util.getUserLanguage(),
                ...
                _this.table.on("click", "th input:checkbox", function() {
                    var box = this;
                    _this.table.find("tr > td:first-child input:checkbox").each(function() {
        ...
        getSelected: function(filter) {
            ...
            this.dataTable.find("tbody input:checkbox:checked").each(function() {
                var tr = $(this).closest("tr"), index = tr.index(), data = _this.dataTable.fnGetData(tr.get(0));
                if (filter) {
...
(function(factory) {
    if (typeof define === "function" && define.cmd) {
        define("jquery/dataTables/1.9.4/jquery.dataTables.bootstrap-debug", [ "jquery-debug" ], function(require) {
            var jQuery = require("jquery-debug");
            factory(require("jquery/dataTables/1.9.4/jquery.dataTables-debug"));
            return jQuery;
        });
    } else {
        factory(jQuery);
    ...
    $.extend($.fn.dataTableExt.oPagination, {
        bootstrap: {
            fnInit: function(oSettings, nPaging, fnDraw) {
                ...
                $(nPaging).addClass("pagination").append("<ul>" + '<li class="prev disabled"><a href="#"><i class="icon-double-angle-left"></i></a></li>' + '<li class="next disabled"><a href="#"><i class="icon-double-angle-right"></i></a></li>' + "</ul>");
                var els = $("a", nPaging);
                $(els[0]).bind("click.DT", {
                    action: "previous"
                }, fnClickHandler);
...
(/** @lends <global> */ function(window, document, undefined) {
    (function(factory) {
        ...
        if (typeof define === "function" && define.amd) {
            ...
            define("jquery/dataTables/1.9.4/jquery.dataTables-debug", [ "jquery-debug" ], function(require) {
                factory(require("jquery-debug"));
                $.extend(true, $.fn.dataTable.defaults, require("jquery/dataTables/1.9.4/locales/jquery.dataTables.{locale}-debug"));
                return $;
            });
...
(function(factory) {
    if (typeof define === "function" && define.cmd) {
        define("jquery/dataTables/1.9.4/locales/jquery.dataTables.zh-CN-debug", [], function() {
            return factory();
        });
    } else {
        $.extend(true, $.fn.dataTable.defaults, factory());
    }
})(function() {
    return {
        oLanguage: {
...
(function(factory) {
    if (typeof define === "function" && define.cmd) {
        define("jquery/bootstrap/datetimepicker/datetimepicker-debug", [ "jquery/bootstrap/bootstrap/2.3.2/bootstrap-debug" ], function(require) {
            require.async("jquery/bootstrap/datetimepicker/datetimepicker-debug.css");
            var $ = require("jquery/bootstrap/bootstrap/2.3.2/bootstrap-debug");
            factory($);
            $.extend($.fn.datetimepicker.dates, require("jquery/bootstrap/datetimepicker/locales/datetimepicker.{locale}-debug"));
            return $;
        });
    } else {
        factory(jQuery);
...
(function(factory) {
    if (typeof define === "function" && define.cmd) {
        define("jquery/bootstrap/datetimepicker/locales/datetimepicker.zh-CN-debug", [], function() {
            return {
                "zh-CN": factory()
            };
        });
    } else {
        $.fn.datetimepicker.dates["zh-CN"] = factory();
    }
})(function() {
    /**
